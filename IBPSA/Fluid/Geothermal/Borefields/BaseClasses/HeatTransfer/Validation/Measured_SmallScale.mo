...
model Measured_SmallScale
  ...
  parameter Real sizFac=1 "Scaling factor of the experiment";
  ...
  IBPSA.Fluid.Geothermal.Borefields.BaseClasses.HeatTransfer.GroundTemperatureResponse groTemRes(
    ...
    borFieDat=borFieDat,
    forceGFunCalc=true,
    tLoaAgg=15) "Ground temperature response of borehole"
...
equation
  ...
  annotation (experiment(Tolerance=1e-6, StopTime=604800.0),
